...
for valid_fold in CFG.run_folds:
    ...
    # Defining DataSet
    train_dataset = LivenessDataset(CFG, train_df, CFG.train_image_dir, CFG.train_transforms)
    val_dataset = LivenessDataset(CFG, valid_df, CFG.train_image_dir, CFG.val_transforms)
